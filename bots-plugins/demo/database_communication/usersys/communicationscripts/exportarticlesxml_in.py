...
def incommunicate(channeldict, dbconnection):
    ...
    cursor.execute('''SELECT ccodeid, leftcode, rightcode FROM ccode''')
    ...
    # please note the content in the database is not removed; to do that a separate delete query would have to be used.
    return results
