...
class TestTranslate(unittest.TestCase):
    ...
    def testcombinations(self):
        ...
        self.assertEqual('scheme://hostname/filename', str(Uri(scheme='scheme', hostname='hostname', filename='filename')), 'basis')
        self.assertEqual('scheme://hostname:80/filename', str(Uri(scheme='scheme', hostname='hostname', port=80, filename='filename')), 'basis')
