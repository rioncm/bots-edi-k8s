...
{ID: 'ST', MIN: 1, MAX: 1, LEVEL: [
    ...
    {ID: 'VEH', MIN: 0, MAX: 1, LEVEL: [
        {ID: 'K1', MIN: 0, MAX: 10},
        {ID: 'M7', MIN: 0, MAX: 1, LEVEL: [
            {ID: 'K1', MIN: 0, MAX: 10},
        ]},
        {ID: 'CII', MIN: 0, MAX: 1, LEVEL: [
            {ID: 'K1', MIN: 0, MAX: 10},
        ]},
    ]},
    {ID: 'NM1', MIN: 0, MAX: 999, LEVEL: [
        {ID: 'K1', MIN: 0, MAX: 10},
        {ID: 'DMG', MIN: 0, MAX: 1, LEVEL: [
            {ID: 'K1', MIN: 0, MAX: 10},
        ]},
        {ID: 'REF', MIN: 0, MAX: 1, LEVEL: [
            {ID: 'K1', MIN: 0, MAX: 10},
        ]},
        {ID: 'N3', MIN: 0, MAX: 1, LEVEL: [
            {ID: 'K1', MIN: 0, MAX: 10},
        ]},
    ...
    {ID: 'P4', MIN: 1, MAX: 20, LEVEL: [
        ...
        {ID: 'LX', MIN: 0, MAX: 9999, LEVEL: [
            ...
            {ID: 'N1', MIN: 0, MAX: 25, LEVEL: [
                ...
                {ID: 'X1', MIN: 0, MAX: 1, LEVEL: [
                    {ID: 'K1', MIN: 0, MAX: 10},
                ]},
            ]},
            {ID: 'M12', MIN: 0, MAX: 9999, LEVEL: [
                {ID: 'K1', MIN: 0, MAX: 10},
                {ID: 'R4', MIN: 0, MAX: 10, LEVEL: [
                    {ID: 'K1', MIN: 0, MAX: 10},
                ]},
